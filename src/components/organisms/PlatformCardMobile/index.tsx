...
const PlatformCardMobile = () => {
  return (
    <div className="rounded-[12px] shadow-custom flex flex-col bg-white justify-center items-center p-6">
      <Image width={123} height={68} src={PLATFORM} alt="" />
      <p className="text-blackText text-center my-4 font-semibold text-base">
        Native Mobile App Development
      </p>
      <p className="text-blackText text-center text-xs leading-5">
